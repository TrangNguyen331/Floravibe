...
const Checkout = ({ location, cartItems, currency }) => {
  ...
  .then(response => {
    const hcmCity = response.data.filter(city => city.Name === 'Thành phố Hồ Chí Minh');
    setCities(hcmCity);
  })
  ...
  if (selectedCity && selectedDistrict && selectedWard) {
    ...
    const selectedDistrictName = cities.find(city => city.Id === selectedCity).Districts.find(district => district.Id === selectedDistrict).Name
    const selectedWardName = cities.find(city => city.Id === selectedCity).Districts.find(district => district.Id === selectedDistrict).Wards.find(ward => ward.Id === selectedWard).Name
    setSubmitData({
      ...submitData,
                      ...
                      <div className="billing-info mb-20">
                        ...
                        <div>
                          ...
                          aria-label=".form-select-sm">
                            <option value="" disabled>Choose Province/City</option>
                            {cities.map(city =>
                          ...
                          <select
                            ...
                            {selectedCity && cities.find(city => city.Id === selectedCity).Districts.map(district =>
                          ...
                          <select
                            ...
                            {selectedDistrict && cities.find(city => city.Id === selectedCity).Districts.find(district => district.Id === selectedDistrict).Wards.map(ward =>
